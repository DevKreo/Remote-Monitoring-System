  ...
  <v-app id="inspire">
    ...
    >
      <v-list-item two-line>
        <v-list-item-content>
          <v-list-item-title class="purple--text darken-3--text ml-6" id="SDM"
            >SDM</v-list-item-title
          >
          <v-list-item-subtitle class="grey--text lighten-5--text ml-6" id="subtitle"
            >Система дистанционного мониторинга</v-list-item-subtitle
          >
        </v-list-item-content>
      </v-list-item>
      ...
      <v-list dense>
        <v-list-item-group v-model="selectedItem" color="text" dark>
          ...
          <v-list-item v-for="(item, i) in pagesUP" :key="i" mandatory>
            ...
            <v-btn v-if="item.plus" color="purple" elevation="2" fab x-small>
...
export default {
  data: () => ({
    ...
    pagesUP: [
      ...
      { text: "Расписание", icon: "mdi-calendar-range", counter: false, plus: true },
