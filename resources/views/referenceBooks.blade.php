        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                ...
                <ul class="nav nav-tabs mb-2">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="#">Тип устройства</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="#">Тип нарушений</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="#">Производитель устройств</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Адреса</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Ошибка устройств</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Ветки SNMP</a>
                    </li>
                  </ul>
