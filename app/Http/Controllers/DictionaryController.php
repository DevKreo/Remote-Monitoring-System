...
class DictionaryController extends Controller
{
    ...
    public function addressGetData()
    {
        ...
        ->paginate(15);
        return view('adress', ['addresses' => $addresses]);
    }
